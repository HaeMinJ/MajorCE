...
router.get('/', function (req, res, next) {
    connection.query('SELECT * FROM Post as post JOIN User as user WHERE post.boardSeq = ? and post.uploaderSeq = user.userSeq', BOARD_SEQ, function (err, communityList) {
        if (err) {
            console.log(err);
