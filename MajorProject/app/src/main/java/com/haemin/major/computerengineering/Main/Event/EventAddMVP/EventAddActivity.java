...
import com.haemin.major.computerengineering.Main.Community.CommunityAddMVP.CommunityAddContract;
import com.haemin.major.computerengineering.Main.Community.CommunityAddMVP.CommunityAddPresenter;
...
public class EventAddActivity extends AppCompatActivity implements EventAddContract.EventAddView {

    private static final int CODE_IMAGE_REQUEST = 123;
    EventAddPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(this);
        {
            ...
            files = new ArrayList<>();
            presenter = new EventAddPresenter(this, files);
        }
        {
